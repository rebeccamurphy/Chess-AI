(function(){
	...
	Rating.prototype.getRating = function(board, moveListLength, depth) {
		...
		counter+= this.ratePostional(Chess.color, material);
		//for the other team color
		material=this.rateMaterial(oppColor, moveListLength, depth, )
	...
	Rating.prototype.rateMovebility= function (color, moveListLength, depth, material){
		...
		if (moveListLength ===){//current side is in checkmate or stalemate
			/*if (!kingSafe){
